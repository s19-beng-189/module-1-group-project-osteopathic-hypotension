...
Rs=19.05    %original value 17.86 Systemic resistance (mmHg/(liter/minute))
...
RAo=1     %aortic valve resistance (mmHg/(liter/minute))
%The following value of Csa is approximate;
%needs adjustment to make blood pressure 120/80:
Csa=0.001125  %Systemic arterial compliance (liters/mmHg)
